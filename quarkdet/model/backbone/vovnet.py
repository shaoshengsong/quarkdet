...
class _OSA_module(nn.Module):
    def __init__(self,
        ...
        # feature aggregation         in_channel = in_ch + layer_per_block * stage_ch
...
class VoVNet(nn.Module):
    def __init__(self, 
        ...
        # Stem module         stem = conv3x3(3,   64, 'stem', '1', 2)
        ...
        self.stage_names = []
        for i in range(4): #num_stages             name = 'stage%d' % (i+2)
        ...
        self.feature_layer = nn.Linear(config_concat_ch[-1], 128)
